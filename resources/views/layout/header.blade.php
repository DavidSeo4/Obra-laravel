        ...
        <div class="container-fluid02">
          ...
          <div class="collapse navbar-collapse text-uppercase" id="navbarTogglerDemo02">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a href="{{route('index')}}" class="nav-link {{ request()->is('index') ? 'active bg-danger' : '' }}" aria-current="true">Inicio</a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link" aria-current="true">Calendario</a>
                  </li>
                  <li class="nav-item">
                    <a href="{{route('persoas.index')}}" class="nav-link {{ request()->is('persoas*') ? 'active bg-warning' : '' }}" aria-current="true">Persoas</a>
                  </li>
                  <li class="nav-item">
                    <a href="{{route('empresas.index')}}" class="nav-link {{ request()->is('empresas*') ? 'active bg-danger' : '' }}" aria-current="true">Empresas</a>
                  </li>
              <li class="nav-item">
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
              <div class="input-group">
                ...
                <span class="input-group-append">
                  <button class="btn btn-warning rounded-0 rounded-end buscador" type="button">
